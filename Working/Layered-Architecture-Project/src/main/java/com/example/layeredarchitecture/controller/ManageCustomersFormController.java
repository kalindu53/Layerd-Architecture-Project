...
public class ManageCustomersFormController {
   ...
   // ObservableList<CustomerDTO> cus = FXCollections.observableArrayList();
    private void loadAllCustomers() {
        ...
        try {
          ...
          */
            ...
            ArrayList<CustomerDTO> customerDTOS = customerDAO.loadAlCustomers();
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
              ...
              */
               ...
               CustomerDAOImpl customerDAO = new CustomerDAOImpl();
               customerDAO.updateCustomer(name,id,address);
