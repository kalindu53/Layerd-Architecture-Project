...
public class CustomerDAOImpl {
    ...
    public ArrayList<CustomerDTO> loadAlCustomers() throws SQLException, ClassNotFoundException {
    ...
    public void updateCustomer(String name, String id, String address) throws SQLException, ClassNotFoundException {
        Connection connection = DBConnection.getDbConnection().getConnection();
