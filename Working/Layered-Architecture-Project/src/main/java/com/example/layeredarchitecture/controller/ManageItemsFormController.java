...
import com.example.layeredarchitecture.dao.ManageItemDAOImpl;
...
public class ManageItemsFormController {
    ...
    private void loadAllItems() {
        ...
        try {
            ...
            */
            ManageItemDAOImpl manageItemDAO = new ManageItemDAOImpl();
            ArrayList<ItemDTO> itemDTOS = manageItemDAO.loadAll();
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            try {
               ...
               */
                ...
                ManageItemDAOImpl manageItemDAO = new ManageItemDAOImpl();
                manageItemDAO.SaveItem(code,description,unitPrice,qtyOnHand);
